...
function parsePassageText(chapter: number, passageText: string): ChapterData {
        ...
        if (p.nodeName === 'h3') {
            ...
            return {
                ...
                x: p.childNodes.map(c => {
                    if (c.nodeName === 'sup') {
                        const t = c.childNodes[0].value;
                        const { vStart, vEnd } = getVerseNumbers(t);
                        return {
                            k: 'verse',
                            t,
                            vStart,
    ...
    const numbered = paragraphs.filter(p => p).map((p, i) => {
        ...
        const vStart = vNumbers[0].vStart;
        const vEnd = vNumbers[vNumbers.length - 1].vEnd;
        return {
            vStart,
            vEnd,
            ...p
    ...
    // Reverse Label Headers 
    const numberedReverse = numbered.slice().reverse();
...
function getVerseNumbers(v: string) {
    ...
    const vStart = parseInt(parts[1]);
    const vEnd = parts[2] && parseInt(parts[2].substr(1)) || vStart;
    return {
        vStart,
        vEnd
    };
...
export function test_convertToChapterData() {
    const data = parsePassageText(1, testPassageText3);
...
const testPassageText3 = `
<h3 class=\"s\">Messages of Judgment<\/h3>\n<h3 class=\"s\">Quit Your Worship Charades<\/h3>\n<p class=\"p\"><sup id=\"Isa.1.1\" class=\"v\">1<\/sup>The vision that Isaiah son of Amoz saw regarding Judah and Jerusalem during the times of the kings of Judah: Uzziah, Jotham, Ahaz, and Hezekiah.<sup id=\"Isa.1.2-Isa.1.4\" class=\"v\">2-4<\/sup>Heaven and earth, you're the jury.<\/p>\n<p class=\"q1\">Listen to God's case:<\/p>\n<p class=\"m\">\"I had children and raised them well,<\/p>\n<p class=\"q1\">and they turned on me.<\/p>\n<p class=\"m\">The ox knows who's boss,<\/p>\n<p class=\"q1\">the mule knows the hand that feeds him,<\/p>\n<p class=\"m\">But not Israel.<\/p>\n<p class=\"q1\">My people don't know up from down.<\/p>\n<p class=\"m\">Shame! Misguided God-dropouts,<\/p>\n<p class=\"q1\">staggering under their guilt-baggage,<\/p>\n<p class=\"m\">Gang of miscreants,<\/p>\n<p class=\"q1\">band of vandals\u2014<\/p>\n<p class=\"m\">My people have walked out on me, their God,<\/p>\n<p class=\"q1\">turned their backs on The Holy of Israel,<\/p>\n<p class=\"q1\">walked off and never looked back.<\/p>\n<p class=\"p\"><sup id=\"Isa.1.5-Isa.1.9\" class=\"v\">5-9<\/sup>\"Why bother even trying to do anything with you<\/p>\n<p class=\"q1\">when you just keep to your bullheaded ways?<\/p>\n<p class=\"m\">You keep beating your heads against brick walls.<\/p>\n<p class=\"q1\">Everything within you protests against you.<\/p>\n<p class=\"m\">From the bottom of your feet to the top of your head,<\/p>\n<p class=\"q1\">nothing's working right.<\/p>\n<p class=\"m\">Wounds and bruises and running sores\u2014<\/p>\n<p class=\"q1\">untended, unwashed, unbandaged.<\/p>\n<p class=\"m\">Your country is laid waste,<\/p>\n<p class=\"q1\">your cities burned down.<\/p>\n<p class=\"m\">Your land is destroyed by outsiders while you watch,<\/p>\n<p class=\"q1\">reduced to rubble by barbarians.<\/p>\n<p class=\"m\">Daughter Zion is deserted\u2014<\/p>\n<p class=\"q1\">like a tumbledown shack on a dead-end street,<\/p>\n<p class=\"m\">Like a tarpaper shanty on the wrong side of the tracks,<\/p>\n<p class=\"q1\">like a sinking ship abandoned by the rats.<\/p>\n<p class=\"m\">If God-of-the-Angel-Armies hadn't left us a few survivors,<\/p>\n<p class=\"q1\">we'd be as desolate as Sodom, doomed just like Gomorrah.<\/p>\n<p class=\"p\"><sup id=\"Isa.1.10\" class=\"v\">10<\/sup>\"Listen to my Message,<\/p>\n<p class=\"q1\">you Sodom-schooled leaders.<\/p>\n<p class=\"m\">Receive God's revelation,<\/p>\n<p class=\"q1\">you Gomorrah-schooled people.<\/p>\n<p class=\"p\"><sup id=\"Isa.1.11-Isa.1.12\" class=\"v\">11-12<\/sup>\"Why this frenzy of sacrifices?\"<\/p>\n<p class=\"q1\"><span class=\"it\">God<\/span><span class=\"it\">'<\/span><span class=\"it\">s<\/span> asking.<\/p>\n<p class=\"m\">\"Don't you think I've had my fill of burnt sacrifices,<\/p>\n<p class=\"q1\">rams and plump grain-fed calves?<\/p>\n<p class=\"m\">Don't you think I've had my fill<\/p>\n<p class=\"q1\">of blood from bulls, lambs, and goats?<\/p>\n<p class=\"m\">When you come before me,<\/p>\n<p class=\"q1\">whoever gave you the idea of acting like this,<\/p>\n<p class=\"m\">Running here and there, doing this and that\u2014<\/p>\n<p class=\"q1\">all this sheer commotion in the place provided for worship?<\/p>\n<p class=\"p\"><sup id=\"Isa.1.13-Isa.1.17\" class=\"v\">13-17<\/sup>\"Quit your worship charades.<\/p>\n<p class=\"q1\">I can't stand your trivial religious games:<\/p>\n<p class=\"m\">Monthly conferences, weekly Sabbaths, special meetings\u2014<\/p>\n<p class=\"q1\">meetings, meetings, meetings\u2014I can't stand one more!<\/p>\n<p class=\"m\">Meetings for this, meetings for that. I hate them!<\/p>\n<p class=\"q1\">You've worn me out!<\/p>\n<p class=\"m\">I'm sick of your religion, religion, religion,<\/p>\n<p class=\"q1\">while you go right on sinning.<\/p>\n<p class=\"m\">When you put on your next prayer-performance,<\/p>\n<p class=\"q1\">I'll be looking the other way.<\/p>\n<p class=\"m\">No matter how long or loud or often you pray,<\/p>\n<p class=\"q1\">I'll not be listening.<\/p>\n<p class=\"m\">And do you know why? Because you've been tearing<\/p>\n<p class=\"q1\">people to pieces, and your hands are bloody.<\/p>\n<p class=\"m\">Go home and wash up.<\/p>\n<p class=\"q1\">Clean up your act.<\/p>\n<p class=\"m\">Sweep your lives clean of your evildoings<\/p>\n<p class=\"q1\">so I don't have to look at them any longer.<\/p>\n<p class=\"m\">Say no to wrong.<\/p>\n<p class=\"q1\">Learn to do good.<\/p>\n<p class=\"m\">Work for justice.<\/p>\n<p class=\"q1\">Help the down-and-out.<\/p>\n<p class=\"m\">Stand up for the homeless.<\/p>\n<p class=\"q1\">Go to bat for the defenseless.<\/p>\n<h3 class=\"s\">Let's Argue This Out<\/h3>\n<p class=\"p\"><sup id=\"Isa.1.18-Isa.1.20\" class=\"v\">18-20<\/sup>\"Come. Sit down. Let's argue this out.\"<\/p>\n<p class=\"q1\">This is God's Message:<\/p>\n<p class=\"m\">\"If your sins are blood-red,<\/p>\n<p class=\"q1\">they'll be snow-white.<\/p>\n<p class=\"m\">If they're red like crimson,<\/p>\n<p class=\"q1\">they'll be like wool.<\/p>\n<p class=\"m\">If you'll willingly obey,<\/p>\n<p class=\"q1\">you'll feast like kings.<\/p>\n<p class=\"m\">But if you're willful and stubborn,<\/p>\n<p class=\"q1\">you'll die like dogs.\"<\/p>\n<p class=\"m\">That's right. God says so.<\/p>\n<h3 class=\"s\">Those Who Walk Out on God<\/h3>\n<p class=\"p\"><sup id=\"Isa.1.21-Isa.1.23\" class=\"v\">21-23<\/sup>Oh! Can you believe it? The chaste city<\/p>\n<p class=\"q1\">has become a whore!<\/p>\n<p class=\"m\">She was once all justice,<\/p>\n<p class=\"q1\">everyone living as good neighbors,<\/p>\n<p class=\"m\">And now they're all<\/p>\n<p class=\"q1\">at one another's throats.<\/p>\n<p class=\"m\">Your coins are all counterfeits.<\/p>\n<p class=\"q1\">Your wine is watered down.<\/p>\n<p class=\"m\">Your leaders are turncoats<\/p>\n<p class=\"q1\">who keep company with crooks.<\/p>\n<p class=\"m\">They sell themselves to the highest bidder<\/p>\n<p class=\"q1\">and grab anything not nailed down.<\/p>\n<p class=\"m\">They never stand up for the homeless,<\/p>\n<p class=\"q1\">never stick up for the defenseless.<\/p>\n<p class=\"p\"><sup id=\"Isa.1.24-Isa.1.31\" class=\"v\">24-31<\/sup>This Decree, therefore, of the Master, God-of-the-Angel-Armies,<\/p>\n<p class=\"q1\">the Strong One of Israel:<\/p>\n<p class=\"m\">\"This is it! I'll get my oppressors off my back.<\/p>\n<p class=\"q1\">I'll get back at my enemies.<\/p>\n<p class=\"m\">I'll give you the back of my hand,<\/p>\n<p class=\"q1\">purge the junk from your life, clean you up.<\/p>\n<p class=\"m\">I'll set honest judges and wise counselors among you<\/p>\n<p class=\"q1\">just like it was back in the beginning.<\/p>\n<p class=\"m\">Then you'll be renamed<\/p>\n<p class=\"q1\">City-That-Treats-People-Right, the True-Blue City.\"<\/p>\n<p class=\"m\">God's right ways will put Zion right again.<\/p>\n<p class=\"q1\">God's right actions will restore her penitents.<\/p>\n<p class=\"m\">But it's curtains for rebels and God-traitors,<\/p>\n<p class=\"q1\">a dead end for those who walk out on God.<\/p>\n<p class=\"m\">\"Your dalliances in those oak grove shrines<\/p>\n<p class=\"q1\">will leave you looking mighty foolish,<\/p>\n<p class=\"m\">All that fooling around in god and goddess gardens<\/p>\n<p class=\"q1\">that you thought was the latest thing.<\/p>\n<p class=\"m\">You'll end up like an oak tree<\/p>\n<p class=\"q1\">with all its leaves falling off,<\/p>\n<p class=\"m\">Like an unwatered garden,<\/p>\n<p class=\"q1\">withered and brown.<\/p>\n<p class=\"m\">'The Big Man' will turn out to be dead bark and twigs,<\/p>\n<p class=\"q1\">and his 'work,' the spark that starts the fire<\/p>\n<p class=\"m\">That exposes man and work both<\/p>\n<p class=\"q1\">as nothing but cinders and smoke.\"<\/p>
`;
